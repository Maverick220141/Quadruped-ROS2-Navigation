...
void YESENSE_Publisher::publish_msg(yis_out_data_t *result)
{
    ...
    // Mark orientation as unavailable so downstream nodes ignore it
    imu_ros_data.orientation_covariance[0] = -1.0;
    imu_ros_data.orientation_covariance[1] = 0.0;
    imu_ros_data.orientation_covariance[2] = 0.0;
    imu_ros_data.orientation_covariance[3] = 0.0;
    imu_ros_data.orientation_covariance[4] = 0.0;
    imu_ros_data.orientation_covariance[5] = 0.0;
    imu_ros_data.orientation_covariance[6] = 0.0;
    imu_ros_data.orientation_covariance[7] = 0.0;
    imu_ros_data.orientation_covariance[8] = 0.0;

    // Provide reasonable default diagonal covariances for gyro and accel (optional)
    const double gyr_var = (0.003)*(0.003); // (rad/s)^2
    const double acc_var = (0.05)*(0.05);   // (m/s^2)^2
    imu_ros_data.angular_velocity_covariance[0] = gyr_var;
    imu_ros_data.angular_velocity_covariance[4] = gyr_var;
    imu_ros_data.angular_velocity_covariance[8] = gyr_var;

    imu_ros_data.linear_acceleration_covariance[0] = acc_var;
    imu_ros_data.linear_acceleration_covariance[4] = acc_var;
    imu_ros_data.linear_acceleration_covariance[8] = acc_var;
    pub_imu_ros->publish(imu_ros_data); //tues
	...
	pub_imu->publish(imu_data);		 ////tues_debug
