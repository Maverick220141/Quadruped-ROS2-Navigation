...
[![Build and Test](https://github.com/LihanChen2004/pcd2pgm/actions/workflows/build_and_test.yml/badge.svg)](https://github.com/LihanChen2004/pcd2pgm/actions/workflows/build_and_test.yml)
...
可以通过修改 `pcd2pgm/pcd2pgm.yaml` 文件来配置节点的参数。
  ...
  pcd2pgm:
    ros__parameters:
      pcd_file: configs/pcd/nt_4_all.pcd   # pcd 文件所在目录
